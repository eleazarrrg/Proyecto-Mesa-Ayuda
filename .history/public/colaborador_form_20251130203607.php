...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $colaborador['sexo']             = Validator::sanitizeString($_POST['sexo'] ?? '');
    $colaborador['fecha_nacimiento'] = $_POST['fecha_nacimiento'] ?? '';
    $colaborador['foto_perfil']      = Validator::sanitizeString($_POST['foto_perfil'] ?? '');    
...
<body>
    ...
    <form method="POST">
        ...
        <select name="sexo">
            ...
            <option value="O" <?= $colaborador['sexo'] == 'O' ? 'selected' : ''; ?>>Otro</option>
        </select>
        <br><br>

        <label>Fecha de nacimiento:</label><br>
        <input type="date" name="fecha_nacimiento" value="<?= htmlspecialchars($colaborador['fecha_nacimiento']); ?>">
        <br><br>

        <label>Foto de perfil (URL o nombre de archivo):</label><br>
        <input type="text" name="foto_perfil" value="<?= htmlspecialchars($colaborador['foto_perfil']); ?>">
        <br><br>
